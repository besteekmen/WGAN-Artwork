...
HOLE_LAMBDA = 6.0 # full weight for missing region, reduced from 6.0 to avoid large gradients
VALID_LAMBDA = 1.0 # smaller for known region (was 0.1)
L1_LAMBDA = 10.0 # was 10.0 reconstruction loss weight
STYLE_LAMBDA = 30.0 # was 120.0 # was 250 reduce to 10 if G NaN
ADV_LAMBDA = 0.01 # small weight for adversarial loss (for stable training)
