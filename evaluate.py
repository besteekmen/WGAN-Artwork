...
from utils.utils import to_unit, to_signed, print_device, set_seed, get_device, is_cuda, to_u8
from config import CROP_SIZE, NUM_WORKERS, SEED, BATCH_SIZE, DATA_PATH
...
def evaluate(model_path, out_dir="eval_outputs",
    ...
    # Load generator
    netG = AOTGenerator().to(device).eval()
